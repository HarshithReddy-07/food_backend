# Generated by Django 4.2.25 on 2025-11-04 15:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('googleId', models.CharField(blank=True, db_index=True, max_length=255, null=True, unique=True)),
                ...
                ('sessionInfo', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mealType', models.CharField(blank=True, max_length=50, null=True)),
